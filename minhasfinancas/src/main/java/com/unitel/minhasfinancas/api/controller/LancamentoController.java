package com.unitel.minhasfinancas.api.controller;
...
import com.unitel.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.unitel.minhasfinancas.api.dto.LancamentoDTO;
...
import com.unitel.minhasfinancas.service.LancamentoService;
...
public class LancamentoController {
    ...
    public ResponseEntity buscar(
       ...
       if(!usuario.isPresent()){
        return ResponseEntity.badRequest().body("Não foi possível realizar a contulta.  Usuario não encontrado para o ID informado");
       }else{
